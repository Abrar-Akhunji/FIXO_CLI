...
// loop-trap test always imported directly from runtime/loop-trap,
// and SingleAgent never used this path). Callers that need the
// detector should import from '../runtime/loop-trap.js' directly.
