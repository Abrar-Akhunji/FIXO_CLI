...
export const TOOL_DEFINITIONS: ChatToolDefinition[] = [
  ...
  },
  {
    ...
    function: {
      name: "apply_patch",
      description:
        "Apply a unified diff patch to files in the workspace. Prefer this over write_file for editing existing files, and NEVER substitute it with `sed -i`, `patch < file`, or `python3 -c` — shell file-writing is sandbox-blocked.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      name: "replace_range",
      description:
        "Replace inclusive 1-based line range in a file. Requires reading the file first.",
      parameters: {
        type: "object",
        properties: {
          path: { type: "string" },
  ...
  },
  {
    ...
    function: {
      name: "insert_after",
      description:
        "Insert content after the first exact anchor match in a file. Requires reading the file first.",
      parameters: {
        type: "object",
        properties: {
          path: { type: "string" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          jobId: {
            type: "string",
            description: "The jobId returned by run_command_async.",
          },
          tailLines: {
            type: "integer",
            description: "Truncate each stream to last N lines.",
          },
          sinceBytes: {
            type: "integer",
            description: "Return only bytes after this offset.",
          },
        },
        required: ["jobId"],
      },
  ...
  },
  {
    ...
    function: {
      name: "kill_command",
      description:
        "Send SIGTERM to a background job. No-op if the job has already exited.",
      parameters: {
        type: "object",
        properties: {
      ...
      parameters: {
        ...
        properties: {
          path: {
            type: "string",
            description:
              "The file path to delete, relative to the workspace root or absolute.",
          },
        },
        required: ["path"],
      },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Find definition coordinates for a symbol at a given 0-indexed line and character position using LSP.",
      parameters: {
        type: "object",
        properties: {
          path: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Find all reference locations for a symbol at a given 0-indexed line and character position using LSP.",
      parameters: {
        type: "object",
        properties: {
          path: {
  ...
  },
  {
    ...
    function: {
      name: "lsp_hover",
      description:
        "Retrieve type information and documentation for a symbol at a given 0-indexed line and character position using LSP.",
      parameters: {
        type: "object",
        properties: {
          path: {
  ...
  },
  {
    ...
    function: {
      name: "web_fetch",
      description:
        "Fetch a webpage using an HTTP GET request and return its content converted to Markdown. Use this to read documentation or external references.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      name: "web_search",
      description:
        "Perform a web search for a given query and return a list of search results as Markdown snippets. Use this to find information on the web.",
      parameters: {
        type: "object",
        properties: {
      ...
      parameters: {
        ...
        properties: {
          path: {
            type: "string",
            description:
              "The file path to edit, relative to the workspace root or absolute.",
          },
          oldString: {
            type: "string",
            description:
              "The exact substring to replace. Must appear in the file.",
          },
          newString: {
            type: "string",
      ...
      parameters: {
        ...
        properties: {
          pattern: {
            type: "string",
            description:
              'Glob pattern, e.g. "src/**/*.ts" or "**/package.json".',
          },
          cwd: {
            type: "string",
            description:
          ...
          maxResults: {
            type: "integer",
            description:
              "Maximum number of results to return. Default 1000, hard cap 5000.",
          },
          includeHidden: {
            type: "boolean",
            description:
              "If true, do not exclude dotfile entries from the match. Default false.",
          },
          followSymlinks: {
            type: "boolean",
            description:
